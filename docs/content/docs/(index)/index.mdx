...
<div className="grid grid-cols-1 md:grid-cols-2 gap-4 my-8">
  ...
  <Card title="AI Magic Fix" icon={<LucideScale className="w-6 h-6 text-blue-500" />}>
    The first scanner that actually FIXES code. Get context-aware, syntax-valid patches delivered instantly via a premium TUI.
  </Card>
</div>
...
### 🧠 AI remediation (v1.3.0)
- **AI Magic Fix**: Automatically remediate vulnerabilities with context-aware patches.
- **Gemini 2.5 Flash**: Upgraded AI engine for faster and more accurate security fixes.
- **Risk Scoring**: Every finding is assigned an AI-calculated risk score (0-100) to help you prioritize.
- **Actionable Fixes**: Don't just find bugs—fix them with 100% verified accuracy.
